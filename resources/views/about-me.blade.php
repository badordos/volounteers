...
@section('content')
    ...
    <div class="main
        ...
        <div class="main__inner">
            ...
            <personal-user name="{{$user->name}}"
                           location="{{$city = $city ? $city->title : ''}}" id="scrollMy"
                           photo="
                            @if($user->image !== null)
                                /storage/{{ $user->image }}
                            @else
            ...
            <about-campaigns id="scrollMyCampaigns">
                <template slot="filter">
                    @include('parts.campaigns_filter', ['flags' => 'filter', 'title' => 'My campaigns', 'verification' => '', 'createCampaign' => 'true', 'disabledBtnFilter' => 'true'])
                </template>
            ...
            <achievements id="scrollMyAchievements">
                <h1 slot="title">My achievements</h1>
